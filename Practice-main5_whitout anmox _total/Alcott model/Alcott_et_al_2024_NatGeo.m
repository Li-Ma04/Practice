...
Norm_O2_A = O2_A / present.O2_A ;
Norm_O2_A = O2_A / present.O2_A ;
Norm_NO3 = (NO3_P + NO3_D + NO3_S+ NO3_DP)/(present.NO3_P + present.NO3_D + present.NO3_S+ present.NO3_DP) ;
%% Marine Carbon Cycle
...
%%%%% Proximal
NO3_denit_P = NO3_Pdenit *  (1+ (1 - (O2_Pconc / present.Conc_O2_P ))) * (NO3_Pconc/starting.NO3_Pconc)  ;

%%%% Distal
NO3_denit_D =NO3_Ddenit *  (1+ (1 - (O2_Dconc / present.Conc_O2_D )))  * (NO3_Dconc/starting.NO3_Dconc) ;

%%%% Surface Ocean
NO3_denit_S =NO3_Sdenit * (1+ (1 - (O2_Sconc / present.Conc_O2_S ))) * (NO3_Sconc/starting.NO3_Sconc)  ;

%%%%% Deep Ocean
NO3_denit_DP =NO3_DPdenit * (1+ (1 - (O2_DPconc / present.Conc_O2_deep ))) * (NO3_DPconc/starting.NO3_DPconc) ;
...
Norm_Nitri = (NO3_Nitri_P + NO3_Nitri_D + NO3_Nitri_S + NO3_Nitri_DP) / (NO3_PNitri + NO3_DNitri + NO3_SNitri + NO3_DPNitri) ;
...
% fraction = 0.3 / ( 1+ exp(-3*(NO3_DPconc*1000-sensparams.Fraction)));
% % fanoxicprox = 1 / ( 1 + exp(-kanox * ( kU * Norm_newp_P - O2O20 ) ) ) ; 


total_marine_denit_W = 0.3 * total_marine_denit * Norm_Nitri * Norm_NO3 * (1+(1-Norm_O2_A));
total_marine_denit_S = 0.7 * total_marine_denit * Norm_NO3 * (1+(1-Norm_O2_A)) ;
dy(40) = River_NH4 + River_NO3 + total_marine_Nfix - total_marine_denit - total_marine_bury;
dy(41) = (River_NH4 * d15N_NH4_Riv + River_NO3 * d15N_NO3_Riv + total_marine_Nfix * d15N_Nfix - total_marine_denit_W * delta_Wdenit - total_marine_denit_S * N_15N - total_marine_bury * N_15N )/N_total;
